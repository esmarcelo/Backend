...
public class CompaniesController {
	...
	public void createCompany(@RequestBody Companies companies/*@RequestParam("comp_name") String comp_name, @RequestParam("comp_state") String comp_state, @RequestParam("comp_city") String comp_city, 
